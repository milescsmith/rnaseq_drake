...
#source("/home/rstudio/oldworkspace/analysis/rnaseq/covid/covid_pcv/_drake.R")
source("/home/rstudio/oldworkspace/analysis/rnaseq/covid/covid_pcv/code/packages.R", local = knitr::knit_global())
source("/home/rstudio/oldworkspace/analysis/rnaseq/covid/covid_pcv/code/functions.R", local = knitr::knit_global())
source("/home/rstudio/oldworkspace/analysis/rnaseq/covid/covid_pcv/code/extant_modules.R", local = knitr::knit_global())
...
```{r wgcna_eigenvalues, echo=FALSE, include=FALSE}
range_bound = 4
zscore_range <- c(-range_bound:range_bound)
```
...
```{r wgcna_gsea_load, echo=FALSE, include=FALSE}
loadd(MEplotting)
```

```{r wgcna_gsea, fig.height=11, fig.width=12, message=FALSE, warning=FALSE}
plots <-
...
facet_pages <- n_pages(plots + facet_grid_paginate(vars(module),ncol = 2,nrow = 3,scales = "free",page = 1))

for (i in seq(facet_pages-1)){
 print(
  plots +
    facet_grid_paginate(
      vars(module),
